...
nitrowithleaves = left_join(nitrogeninfo, leafinfo)

# JUST NOTICED: A few of my leaf APE13C values are negative.
# this means I need to "force" my C isotope values to be at minimum
# 1 ppm excess before I can log transform anything.
# and I nee
nitrowithleaves$leaflog13C = log(nitrowithleaves$leaf.ppm13Cexcess)

nitrowithleaves$forced.leaves.N15ppmexcess = nitrowithleaves$leaf.ppm15Nexcess +
  forcefactor + 1

nitrowithleaves$leaflog15N = log(nitrowithleaves$forced.leaves.N15ppmexcess)
