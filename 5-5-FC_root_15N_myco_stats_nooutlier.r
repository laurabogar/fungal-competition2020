...
# rootNformycoN_log_linear = lm(nmN15ppmexcess ~ mycologN15, data = nitrogeninfo_nooutlier)
# plot(rootNformycoN_log_linear) 
# summary(rootNformycoN_linear)

rootNformycoN_loglog_linear = lm(nmlogN15 ~ mycologN15, data = nitrogeninfo_nooutlier)
